                ...
                <div id="bg-info" class="panel-collapse collapse show">
                    <div class="portlet-body">
					  	...
					  	@endif
							...
							{{ Form::model($senha, ['method' => 'PATCH', 'url' => 'alterarSenha/'.$senha[0]->id]) }}
								<div class="row">
									<div class="col-sm-6">
										{{ Form::label('nome', 'Nome') }}
										{{ Form::input('text', 'nome', isset($senha)? $senha[0]->name : '', ['class' => 'form-control', 'required']) }}
									</div>
									<div class="col-sm-6">
										{{ Form::label('email', 'E-mail') }}
										{{ Form::input('text', 'email', isset($senha)? $senha[0]->email : '', ['class' => 'form-control', 'required']) }}
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
